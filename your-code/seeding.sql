...
CUSTOMERS
 insert into customers (ID_customers, customers_id, Name, phone_number, email, address, city, state_province, country, zip_code)
...
insert into sales_person (id_staff, sales_id, staff_name, store_location)
values
...
insert into invoices (invoice_id, id_invoice, date, invoice_number, customers_ID_customers, sales_person_id_staff, Cars_id_cars)
values
